...
import '../../login/time_maneger.dart';
...
class _WorkoutCalculatorState extends State<WorkoutCalculator> {
  ...
  //   // A timer that decrements every second
  //   Future.delayed(const Duration(seconds: 1), () {
  //     if (_remainingTime > 0) {
  //       setState(() {
  //         _remainingTime--;
  //       });
  //       _startCountdownTimer(); // Continue the timer
  //     } else {
  //       // Handle logout logic here when the timer reaches 0
  //     }
  //   });
  // }
