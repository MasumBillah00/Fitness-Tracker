...
class _MonthlyProgressChartState extends State<MonthlyProgressChart> {
  ...
  void initState() {
    ...
    // Set the initial position to the index of the selected month
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          // ... The rest of the widget remains unchanged ...
          Expanded(
            child: BlocBuilder<WorkoutBloc, WorkoutState>(
              builder: (context, state) {
                if (state is WorkoutsLoading) {
...
// Custom widget for Scrollable Month Picker
class ScrollableMonthPicker extends StatelessWidget {
  final List<String> months;
  final FixedExtentScrollController scrollController;
  final String selectedMonth;
  final ValueChanged<String> onMonthSelected;

  const ScrollableMonthPicker({
            ...
            return Center(
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                  color: value == selectedMonth ? Colors.blue : Colors.black,
                ),
              ),
            );
          }).toList(),
