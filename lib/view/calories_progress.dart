...
// Custom painter to draw an arrow from (0,0)
// class ArrowPainter extends CustomPainter {
//   final double maxY;
//
//   ArrowPainter(this.maxY);
//
//   @override
...
//       ..strokeWidth = 2;
//
//     // Start from the origin (bottom left)
//     final start = Offset(60, size.height -60);
//
//     // End at the middle of the canvas
...
//
//     // Draw the arrowhead
//     final arrowHeadSize = 10.0; // Adjusted to be more reasonable
//     final angle = 20.0 * (pi / 180.0);
//
//     final arrowLeft = Offset(
//       end.dx - arrowHeadSize * cos(angle),
//       end.dy + arrowHeadSize * sin(angle),
//     );
