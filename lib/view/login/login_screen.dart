...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    // Add BlocListener for authentication status changes
    WidgetsBinding.instance?.addPostFrameCallback((_) {
      context
        ...
        if (state.status == LoginStatus.success) {
          _initializeTimer(); // Start or reset the timer after successful login
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            _loginBloc.add(LoginSubmitted(context));
                          }
                        },
